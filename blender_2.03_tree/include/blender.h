 ...
 * 
 * Version: $Id: blender.h,v 1.34 2000/09/24 20:22:09 ton Exp $ 
 * 
 */
...
typedef struct RenderData {
	...
	/* uit buttons: */
	short xsch, ysch; /* The desired number of pixels in the x, y direction  */
	short xasp, yasp; /* Adjustment factors for the aspect ratio             */
	short xparts, yparts; /* How many parts to use in x, y                   */
	rctf safety, border;
	...
	short alphamode, dogamma, osa; /* just a small aside: the short          */
