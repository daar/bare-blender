 ...
 * 
 * Version: $Id: graphics.h,v 1.7 2000/07/28 14:04:15 frank Exp $
 */
...
#define GLUT_BITMAP_HELVETICAB_14	(&glutBitmapHelveticaBold12)

#define GLUT_BITMAP_HELVETICA_8		(&glutBitmapHelvetica10)
...
#define CURSOR_NONE			GLUT_CURSOR_NONE
...
extern void sdrawline(short x1, short y1, short x2, short y2);
extern void fdrawline(float x1, float y1, float x2, float y2);
extern void fdrawbox(float x1, float y1, float x2, float y2);
