 ...
 * Version: $Id: iff.h,v 1.5 2000/09/14 15:56:44 coockie Exp $
 */
#ifndef IFF_H
#define IFF_H
...
extern void bptolscanl(uint *buf, int size, uint **list1, int nobp, int offset);
extern void bptolong(struct ImBuf *ibuf);
extern void ltobpscanl(uint *rect, int x, uint **list1, int nobp, int offset);
...
/* second arg used to be float* */
extern void cspace(struct ImBuf *,float mat[][4]);
/*
...
extern ImBuf *ibImageFromMemory(int *, int, int);
