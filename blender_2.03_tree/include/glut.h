...
/*
 * Version: $Id: glut.h,v 1.3 2000/07/25 08:53:07 nzc Exp $
 */
...
#ifdef __BeOS
extern int BeOS_escape;
extern int glut_system_time(void);
typedef void *GLUTbitmapFont;
extern void glutBitmapStr(GLUTbitmapFont font, char *str);
...
extern void glutInvertLine(int x1, int y1, int x2, int y2);
extern void glutCustomCursor(char *data1, char *data2, int size);
extern int glutqtest(void);
extern int processEventsAndTimeouts(void);
extern void glutGetFrontBuffer(int x, int y, int sx, int sy);
#endif
...
#define GLUT_SHIFT               221
#define GLUT_CTRL                222
#define GLUT_ALT                 224
