...
/* function keys */
#define GLUT_KEY_F1			301
#define GLUT_KEY_F2			302
#define GLUT_KEY_F3			303
#define GLUT_KEY_F4			304
#define GLUT_KEY_F5			305
#define GLUT_KEY_F6			306
#define GLUT_KEY_F7			307
#define GLUT_KEY_F8			308
#define GLUT_KEY_F9			309
#define GLUT_KEY_F10			310
#define GLUT_KEY_F11			311
#define GLUT_KEY_F12			312

/* directional keys */
#define GLUT_KEY_LEFT			400
#define GLUT_KEY_UP			401
#define GLUT_KEY_RIGHT			402
#define GLUT_KEY_DOWN			403
#define GLUT_KEY_PAGE_UP		404
#define GLUT_KEY_PAGE_DOWN		405
#define GLUT_KEY_HOME			406
#define GLUT_KEY_END			407
#define GLUT_KEY_INSERT			408
#define GLUT_KEY_DELETE			409

#define GLUT_KEY_PAD_0			500
#define GLUT_KEY_PAD_1			501
#define GLUT_KEY_PAD_2			502
#define GLUT_KEY_PAD_3			503
#define GLUT_KEY_PAD_4			504
#define GLUT_KEY_PAD_5			505
#define GLUT_KEY_PAD_6			506
#define GLUT_KEY_PAD_7			507
#define GLUT_KEY_PAD_8			508
#define GLUT_KEY_PAD_9			509
#define GLUT_KEY_PAD_DIVIDE		510
#define GLUT_KEY_PAD_MULTIPLY		511
#define GLUT_KEY_PAD_SUBTRACT		512
#define GLUT_KEY_PAD_ADD		513
#define GLUT_KEY_PAD_RETURN		514
#define GLUT_KEY_PAD_DECIMAL		515

#define GLUT_KEY_CONTROL		600
#define GLUT_KEY_ALT			601
#define GLUT_KEY_SHIFT			602
#define GLUT_KEY_CAPITAL		603
...
#define GLUT_BITMAP_HELVETICAB_8	((void*)9)
#define GLUT_BITMAP_HELVETICAB_10	((void*)10)
#define GLUT_BITMAP_HELVETICAB_12	((void*)11)
#define GLUT_BITMAP_HELVETICAB_14	((void*)12)
#define GLUT_BITMAP_SCREEN_12		((void*)13)
#define GLUT_BITMAP_SCREEN_15		((void*)14)
#endif
#else
...
extern void *glutBitmapHelveticaBold14;
...
#define GLUT_BITMAP_HELVETICAB_14	(&glutBitmapHelveticaBold14)
#endif
#endif
...
extern int APIENTRY glutGetActiveWindow(void);
...
extern void APIENTRY glutBitmapStr(void *font, char *str);
...
/* 
 * Blender API additions 
 */
extern int glutGetQual(void);
extern int glutGetMouseButton(void);
extern void glutGetMouse(short *mval);
extern void glutPutFrontBuffer(void);
extern void glutGetFrontBuffer(int x, int y, int sx, int sy);
extern void glutCustomCursor(char *data1, char *data2, int size);
extern void glutInvertLine(int a, int b, int c, int d);
extern void glutprocessEventsAndTimeouts(void);
extern int glutqtest(void);
